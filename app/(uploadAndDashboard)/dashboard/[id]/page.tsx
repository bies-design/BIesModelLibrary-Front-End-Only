        ...
        <div className='min-h-screen bg-[#27272A] relative'>
            ...
            <div className='flex w-full min-h-screen gap-4 p-2 relative overflow-hidden'>
                <button 
                    ...
                    className={`md:hidden py-2 fixed top-1/2 -translate-y-1/2 rounded-r-lg text-white bg-[#3F3F46] transition-all duration-300 shadow-[0px_0px_2px_0px_#000000B2,inset_0px_-4px_4px_0px_#00000040,inset_0px_4px_2px_0px_#FFFFFF33]
                    active:scale-95 z-70
                    ${isMobileMenuOpen ? "left-[250px]" : "left-0"}
                    `}
