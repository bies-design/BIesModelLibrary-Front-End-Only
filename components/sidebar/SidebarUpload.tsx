...
const SidebarUpload = ({ currentStep,onNext,onBack }: SidebarUploadProps) => {
    ...
    return (
        <aside style={{backdropFilter:'blur(100px)',backgroundColor: '#A1A1AA40',}} className="w-full h-full px-5 py-8 rounded-lg border-[5px] border-[rgba(40,48,62,0.6)] flex flex-col shadow-[inset_0_0_20px_rgba(255,255,255,0.1)] justify-between">
